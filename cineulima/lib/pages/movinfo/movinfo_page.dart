...
class MovinfoPage extends StatelessWidget {
  ...
  Widget _buildBody(BuildContext context) {
    var p = controller.pelicula;
    print(p.value.peliculadata.titulo);
                    ...
                    Positioned(
                      ...
                      child: Container(
                          ...
                          child: Column(children: [
                            Text(p.value.peliculadata.titulo,
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          color: Color(
                              0xFF000C78),
                          // Use Color class to specify color from hex
                          fontWeight: FontWeight.bold, // Set text to bold
                        ),
                      ),
                      SizedBox(height: 8),
                      Text(
                        p.value.peliculadata.sinopsis,
                      ...
                      SizedBox(
                          height: 2),
                      // Espacio entre el texto y la lista de actores
                      SizedBox(
                        height: 100,
                        child: ListView.builder(
                          padding: EdgeInsets.only(left: 20),
                          physics: NeverScrollableScrollPhysics(),
                          itemCount: (p.value.peliculadata.actores.length / 2)
                            ...
                            return Padding(
                              ...
                              child: Row(
                                children: [
                                  Expanded(
                                    child: Text(
                                      '• ${p.value.peliculadata.actores[index *
                                          2]}',
                                      style: TextStyle(fontSize: 12.5),
                                    ),
                                  ),
                                  SizedBox(width: 8),
                                  // Espacio entre los actores
                                  Expanded(
                                    child: (index * 2 + 1 <
                                        p.value.peliculadata.actores.length)
                                        ? Text(
                                      '• ${p.value.peliculadata.actores[index *
                                          2 + 1]}',
                                      style: TextStyle(fontSize: 12.5),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: controller.fetchPeliculasInfo(pId),
